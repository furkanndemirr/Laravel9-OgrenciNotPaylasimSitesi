                        ...
                        <table class="table mb-none">
                            ...
                            @foreach($data as $rs)
                                <tr>
                                    ...
                                    <td></td>
                                    <td><a href="{{route('admin.user.show',['id'=>$rs->id])}}" class="mb-xs mt-xs mr-xs btn btn-success" onclick="return !window.open(this.href, '','top=50 left=100 width=1100 height=700')">Show</a></td>
